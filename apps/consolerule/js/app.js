$(document).ready(function(){
    $.ajax('http://api.susi.ai/learning/rule.json?action=list', {
        dataType: "jsonp",
    ...
    $('#test').click(function(){
        ...
        window.location = 'http://api.susi.ai/learning/rule.json?action=test&test='+testname+'&url='+url+'&name='+name+'&path='+path;
    });
    $('#learn').click(function(){
        ...
        var name = $('#inputName').val();
        var path = $('#inputPath').val();
        window.location = 'http://api.susi.ai/learning/rule.json?action=learn&test='+testname+'&url='+url+'&name='+name+'&path='+path;
    });
